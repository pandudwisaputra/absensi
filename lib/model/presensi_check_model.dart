...
class PresensiCheckRepository {
  static Future<PresensiCheckModel?> getPresensiCheck(BuildContext context) async {
    PresensiCheckModel? _presensiCheck;
    try {
      ...
      if (response.statusCode == 200) {
        PresensiCheckModel decode = PresensiCheckModel.fromJson(jsonDecode(response.body));
        _presensiCheck = decode;
      }
    } catch (e) {
