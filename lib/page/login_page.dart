...
import 'package:absensi/page/lupakatasandi_page.dart';
import 'package:absensi/page/register_page.dart';
  ...
  void onPressLogin(BuildContext context) async {
    if (_formKey.currentState!.validate()) {
      ...
      if (status == 200) {
        ...
        await Navigator.pushReplacement(
            context, CupertinoPageRoute(builder: (context) => const Navbar()));
        setState(() {
          _state = false;
        });
      } else {
